...
import 'package:mbti/screens/celebrities/components/progress_bar.dart';
import 'package:mbti/screens/celebrities/components/question_card.dart';
...
class _BodyScreenState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    ...
    CelEasyQuestionController _questionController = Get.put(CelEasyQuestionController());
    return WillPopScope(
      onWillPop: () async {
                        ...
                        children: [
                          Padding(
                            ...
                            child: Obx(
                                ...
                                TextSpan(
                                  text:
                                  "Easy : Question # ${_questionController.questionNumber.value}",
                                  style: new TextStyle(
