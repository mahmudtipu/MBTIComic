...
import 'package:mbti/screens/celebrities/celebritiesinsane/insanecomponents/insaneprogress_bar.dart';
import 'package:mbti/screens/celebrities/celebritiesinsane/insanecomponents/insanequestion_card.dart';
...
class _BodyScreenState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    ...
    CelInsaneQuestionController _questionController = Get.put(CelInsaneQuestionController());
    return WillPopScope(
      onWillPop: () async {
